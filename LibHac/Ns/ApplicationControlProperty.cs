...
public struct ApplicationControlProperty
{
    ...
    [UnscopedRef] public readonly U8Span IsbnString => new(Isbn);
    [UnscopedRef] public readonly U8Span DisplayVersionString => new(DisplayVersion);
    [UnscopedRef] public readonly U8Span ApplicationErrorCodeCategoryString => new(ApplicationErrorCodeCategory);
    [UnscopedRef] public readonly U8Span BcatPassphraseString => new(BcatPassphrase);
    ...
    public struct ApplicationTitle
    {
        ...
        [UnscopedRef] public readonly U8Span NameString => new(Name);
        [UnscopedRef] public readonly U8Span PublisherString => new(Publisher);
    }
