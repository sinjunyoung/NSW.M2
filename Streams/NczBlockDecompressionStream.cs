...
public class NczBlockDecompressionStream : Stream
{
    ...
    public NczBlockDecompressionStream(NczHeader nczHeader, Stream nczStream)
    {
        ...
        _blocks = [.. BlocksBuilder.Build(_nczBlockCompressionHeader, nczHeader.CompressionStartOffset)];
    }
...
public class BlocksCacheManager
{
    ...
    {
        ArgumentNullException.ThrowIfNull(blockInfo);
        ArgumentNullException.ThrowIfNull(blockBuffer);
