...
/// </summary>
public class NczToNcaStream(byte[] headerBytes, Stream decompressionStream, long ncaSize) : Stream
{
    private long _actualNcaPosition = 0;
    private bool _disposed = false;


    private readonly Stream _decompressionStream = decompressionStream ?? throw new ArgumentNullException(nameof(decompressionStream));
    private readonly byte[] _headerBytes = headerBytes ?? throw new ArgumentNullException(nameof(headerBytes));
